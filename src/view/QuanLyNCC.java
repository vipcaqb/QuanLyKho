...
public class QuanLyNCC extends JFrame {
	...
	public QuanLyNCC() {
		...
		scrollPane_1.setBounds(37, 180, 762, 286);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Ma NCC", "T\u00EAn NCC", "\u0110\u1ECBa ch\u1EC9", "SDT", "FAX"
			}
		));
